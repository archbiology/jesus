#ifndef SPANISH_JONAH
#define SPANISH_JONAH

#include <bible/book.hpp>

namespace Spanish
{
    class Jonah : public HolyBible::Book
    {
    public:
        Jonah()
            : Book(
                      ...
                      {2,
                       {
                           ...
                           {3, "Me echaste a lo profundo, en medio de los mares, /nY me rodeó la corriente; /nTodas tus ondas y tus olas pasaron sobre mí."},
                           {4, "Entonces dije: Desechado soy de delante de tus ojos; /nMas aún veré tu santo templo."},
                           {5, "Las aguas me rodearon hasta el alma, /nRodeóme el abismo; /nEl alga se enredó a mi cabeza."},
                           {6, "Descendí a los cimientos de los montes; /nLa tierra echó sus cerrojos sobre mí para siempre; /nMas tú sacaste mi vida de la sepultura, oh Jehová Dios mío."},
                           {7, "Cuando mi alma desfallecía en mí, me acordé de Jehová, /nY mi oración llegó hasta ti en tu santo templo."},
                           {8, "Los que siguen vanidades ilusorias, /nSu misericordia abandonan."},
                           {9, "Mas yo con voz de alabanza te ofreceré sacrificios; /nPagaré lo que prometí. /nLa salvación es de Jehová."},
