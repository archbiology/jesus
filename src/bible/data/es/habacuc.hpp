                      ...
                      {3,
                       {
                           ...
                           {2, "Oh Jehová, he oído tu palabra, y temí. /nOh Jehová, aviva tu obra en medio de los tiempos, /nEn medio de los tiempos hazla conocer; /nEn la ira acuérdate de la misericordia."},
                           {3, "Dios vendrá de Temán, /nY el Santo desde el monte de Parán. Selah /nSu gloria cubrió los cielos, /nY la tierra se llenó de su alabanza."},
                           {4, "Y el resplandor fue como la luz; /nRayos brillantes salían de su mano, /nY allí estaba escondido su poder."},
                           {5, "Delante de su rostro iba mortandad, /nY a sus pies salían carbones encendidos."},
                           {6, "Se levantó, y midió la tierra; /nMiró, e hizo temblar las gentes; /nLos montes antiguos fueron desmenuzados, /nLos collados antiguos se humillaron. /nSus caminos son eternos."},
                           {7, "He visto las tiendas de Cusán en aflicción; /nLas tiendas de la tierra de Madián temblaron."},
                           {8, "¿Te airaste, oh Jehová, contra los ríos? /n¿Contra los ríos te airaste? /n¿Fue tu ira contra el mar /nCuando montaste en tus caballos, /nY en tus carros de victoria?"},
                           {9, "Se descubrió enteramente tu arco; /nLos juramentos a las tribus fueron palabra segura. Selah /nHendiste la tierra con ríos."},
                           {10, "Te vieron y tuvieron temor los montes; /nPasó la inundación de las aguas; /nEl abismo dio su voz, /nA lo alto alzó sus manos."},
                           {11, "El sol y la luna se pararon en su lugar; /nA la luz de tus saetas anduvieron, /nY al resplandor de tu fulgente lanza."},
                           {12, "Con ira hollaste la tierra, /nCon furor trillaste las naciones."},
                           {13, "Saliste para socorrer a tu pueblo, /nPara socorrer a tu ungido. /nTraspasaste la cabeza de la casa del impío, /nDescubriendo el cimiento hasta la roca. Selah"},
                           {14, "Horadaste con sus propios dardos las cabezas de sus guerreros, /nQue como tempestad acometieron para dispersarme, /nCuyo regocijo era como para devorar al pobre encubiertamente."},
                           {15, "Caminaste en el mar con tus caballos, /nSobre la mole de las grandes aguas."},
                           {16, "Oí, y se conmovieron mis entrañas; /nA la voz temblaron mis labios; /nPudrición entró en mis huesos, y dentro de mí me estremecí; /nSi bien estaré quieto en el día de la angustia, /nCuando suba al pueblo el que lo invadirá con sus tropas."},
                           {17, "Aunque la higuera no florezca, /nNi en las vides haya frutos, /nAunque falte el producto del olivo, /nY los labrados /n2 no den mantenimiento, /nY las ovejas sean quitadas de la majada, /nY no haya vacas en los corrales;"},
                           {18, "Con todo, yo me alegraré en Jehová, /nY me gozaré en el Dios de mi salvación."},
                           {19, "Jehová el Señor es mi fortaleza, /nEl cual hace mis pies como de ciervas, /nY en mis alturas me hace andar. /nAl jefe de los cantores, sobre mis instrumentos de cuerdas."},
                       }},
                  }){};
    };
}

#endif // SPANISH_HABAKKUK
