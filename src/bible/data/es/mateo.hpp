                      ...
                      {1,
                       {
                           ...
                           {23, "He aquí, una virgen concebirá y dará a luz un hijo, /nY llamarás su nombre Emanuel, /nque traducido es: Dios con nosotros."},
                      ...
                      {2,
                       {
                           ...
                           {6, "Y tú, Belén, de la tierra de Judá, /nNo eres la más pequeña entre los príncipes de Judá; /nPorque de ti saldrá un guiador, /nQue apacentará a mi pueblo Israel."},
                           ...
                           {15, "y estuvo allá hasta la muerte de Herodes; para que se cumpliese lo que dijo el Señor por medio del profeta, cuando dijo: /nDe Egipto llamé a mi Hijo."},
                           ...
                           {18, "Voz fue oída en Ramá, /nGrande lamentación, lloro y gemido; /nRaquel que llora a sus hijos, /nY no quiso ser consolada, porque perecieron."},
                      ...
                      {3,
                       {
                           ...
                           {3, "Pues éste es aquel de quien habló el profeta Isaías, cuando dijo: par /nVoz del que clama en el desierto: /nPreparad el camino del Señor, /nEnderezad sus sendas."},
                      ...
                      {4,
                       {
                           ...
                           {6, "y le dijo: Si eres Hijo de Dios, échate abajo; porque escrito está: /nA sus ángeles mandará acerca de ti, /ny, /nEn sus manos te sostendrán, /nPara que no tropieces con tu pie en piedra."},
                           ...
                           {15, "Tierra de Zabulón y tierra de Neftalí, /nCamino del mar, al otro lado del Jordán, /nalilea de los gentiles;"},
                           {16, "El pueblo asentado en tinieblas vio gran luz; /nY a los asentados en región de sombra de muerte, /nLuz les resplandeció."},
                      ...
                      {5,
                       {
                           ...
                           {18, "Porque de cierto os digo que hasta que pasen el cielo y la tierra, ni una jota ni una tilde pasará /nde la ley, hasta que todo se haya cumplido."},
                      ...
                      {11,
                       {
                           ...
                           {10, "Porque éste es de quien está escrito: /nHe aquí, yo envío mi mensajero delante de tu faz, /nEl cual preparará tu camino delante de ti."},
                      ...
                      {12,
                       {
                           ...
                           {10, "Y he aquí había allí uno que tenía seca una mano; y preguntaron a Jesús, para poder acusarle: /n¿Es lícito sanar en el día de reposo?"},
                           ...
                           {18, "He aquí mi siervo, a quien he escogido; /nMi Amado, en quien se agrada mi alma; /nPondré mi Espíritu sobre él, /nY a los gentiles anunciará juicio."},
                           {19, "No contenderá, ni voceará, /nNi nadie oirá en las calles su voz."},
                           {20, "La caña cascada no quebrará, /nY el pábilo que humea no apagará, /nHasta que saque a victoria el juicio."},
                           ...
                           {46, "Mientras él aún hablaba a la gente, he aquí su madre y sus hermanos estaban afuera, y le /nquerían hablar."},
                      ...
                      {13,
                       {
                           ...
                           {14, "De manera que se cumple en ellos la profecía de Isaías, que dijo: /nDe oído oiréis, y no entenderéis; /nY viendo veréis, y no percibiréis."},
                           {15, "Porque el corazón de este pueblo se ha engrosado, /nY con los oídos oyen pesadamente, /nY han cerrado sus ojos; /nPara que no vean con los ojos, /nY oigan con los oídos, /nY con el corazón entiendan, /nY se conviertan, /nY yo los sane."},
                           ...
                           {35, "para que se cumpliese lo dicho por el profeta, cuando dijo: /nAbriré en parábolas mi boca; /nDeclararé cosas escondidas desde la fundación del mundo."},
                      ...
                      {15,
                       {
                           ...
                           {8, "Este pueblo de labios me honra; /nMas su corazón está lejos de mí."},
                           {9, "Pues en vano me honran, /nEnseñando como doctrinas, mandamientos de hombres."},
                      ...
                      {21,
                       {
                           ...
                           {5, "Decid a la hija de Sion: /nHe aquí, tu Rey viene a ti, /nManso, y sentado sobre una asna, /nSobre un pollino, hijo de animal de carga."},
                           ...
                           {16, "y le dijeron: ¿Oyes lo que éstos dicen? Y Jesús les dijo: Sí; ¿nunca leísteis: /nDe la boca de los niños y de los que maman /nPerfeccionaste la alabanza?"},
                           ...
                           {42, "Jesús les dijo: ¿Nunca leísteis en las Escrituras: /nLa piedra que desecharon los edificadores, /nHa venido a ser cabeza del ángulo. /nEl Señor ha hecho esto, /nY es cosa maravillosa a nuestros ojos?"},
                      ...
                      {22,
                       {
                           ...
                           {44, "Dijo el Señor a mi Señor: /nSiéntate a mi derecha, /nHasta que ponga a tus enemigos por estrado de tus pies?"},
                      ...
                      {24,
                       {
                           ...
                           {3, "Y estando él sentado en el monte de los Olivos, los discípulos se le acercaron aparte, /ndiciendo: Dinos, ¿cuándo serán estas cosas, y qué señal habrá de tu venida, y del fin del siglo?"},
                      ...
                      {26,
                       {
                           ...
                           {75, "Entonces Pedro se acordó de las palabras de Jesús, que le había dicho: /nAntes que cante el gallo, me negarás tres veces. Y saliendo fuera, lloró amargamente."},
                       }},
                      {27,
                       {
